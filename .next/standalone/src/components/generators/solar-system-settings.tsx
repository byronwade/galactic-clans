			...
			<div className="p-4">
				...
				<div className="space-y-4">
					...
					<div>
						...
						<input type="text" value={config.systemName} onChange={(e) => updateConfig({ systemName: e.target.value })} className="w-full bg-slate-800 border border-slate-600 text-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-orange-400 focus:border-transparent" />
					</div>

					{/* System Type */}
					<div>
						<label className="block text-sm text-slate-300 mb-2">System Type</label>
						<select value={config.starType} onChange={(e) => updateConfig({ starType: e.target.value })} className="w-full bg-slate-800 border border-slate-600 text-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-orange-400 focus:border-transparent">
